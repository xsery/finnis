...
public class MoveNursePadrao : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (finnisRigidBody.velocity.x > 0f && nurseTransform.transform.position.x < LimiteMaximo)
        {
        ...
        if (finnisRigidBody.velocity.x < 0f && nurseTransform.transform.position.x > LimiteMinimo)
        {
            nurseTransform.transform.position = new Vector2(nurseTransform.transform.position.x - 0.1f, nurseTransform.transform.position.y);
            anim.SetBool("nurseiddle", false);
            anim.SetBool("nursemove", true);
        ...
        if (nurseTransform.transform.position.x > LimiteMaximo || nurseTransform.transform.position.x < LimiteMinimo)
        {
